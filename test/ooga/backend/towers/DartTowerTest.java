...
class DartTowerTest {
  ...
  void testCheckBalloonInRangeReturnsTrue() {
    ...
    bloonsList.add(new Bloons(BloonsType.RED, 10,10,5,5));
    bloonsList.add(new Bloons(BloonsType.RED, 15,30,5,5));
    bloonsList.add(new Bloons(BloonsType.RED, 12,22,5,5));
  ...
  void testFindClosestBloon() {
    ...
    bloonsList.add(new Bloons(BloonsType.RED, 10,10,5,5));
    bloonsList.add(new Bloons(BloonsType.RED, 15,30,5,5));
    Bloons expected = new Bloons(BloonsType.RED, 12,22,5,5);
  ...
  void testGetDistance() {
    DartTower testTower = new DartTower(0,0,5);
    Bloons target = new Bloons(BloonsType.RED, 3,4,5,5);
