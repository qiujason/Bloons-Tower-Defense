...
class DartTowerTest {
  ...
  void testCheckBalloonInRangeReturnsTrue() {
    ...
    bloonsList.add(new BasicBloons(1, 10,10,5,5));
    bloonsList.add(new BasicBloons(1, 15,30,5,5));
    bloonsList.add(new BasicBloons(1, 12,22,5,5));
  ...
  void testFindClosestBloon() {
    ...
    bloonsList.add(new BasicBloons(1, 10,10,5,5));
    bloonsList.add(new BasicBloons(1, 15,30,5,5));
    BasicBloons expected = new BasicBloons(1, 12,22,5,5);
  ...
  void testGetDistance() {
    DartTower testTower = new DartTower(0,0,5);
    BasicBloons target = new BasicBloons(1, 3,4,5,5);
